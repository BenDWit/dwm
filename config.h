...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "dina:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_e,          spawn,              {.v = (const char*[]){ "vscodium", NULL } } },
	...
	{ MODKEY,			XK_c,          spawn,                  {.v = (const char*[]){ "gajim", NULL } } },
